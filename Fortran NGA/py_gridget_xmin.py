...
flat = np.arange(north_m, south_m-dlat/2, -(dlat_out/60 / dlat) )
flon = np.arange(west_m,  east_m+dlat/2,   (dlon_out/60 / dlon) )  

irow     = len(flat)
jcol     = len(flon)
fetch = lambda jj : west_j + jj*round(dlat_out/dlat)
